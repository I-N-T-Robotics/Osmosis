...
public class InertialFrame {
    ...
    public static class Builder
    {
        ...
        public InertialFrame.Builder addInput(String s, double scale, double locx, double locy, double dirx, double diry) {
            data.add(new InertialFrameInput(map, s, this.scale, new Vector2d(locx, locy), new Vector2d(dirx, diry)));
            return this;
        }
        public InertialFrame.Builder addInput(String s, double locx, double locy, double dirx, double diry)
        {
